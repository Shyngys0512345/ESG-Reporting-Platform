...
// but they may not be properly exported. Using fallback components.
const PanelGroup = ({ children, ...props }: any) => (
  <div className="flex h-full w-full" {...props}>
    {children}
  </div>
);
...
const PanelResizeHandle = ({ className, ...props }: any) => (
  <div
    className={cn(
